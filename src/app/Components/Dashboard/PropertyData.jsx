            ...
            <div className="max-h-72 overflow-y-auto">
                {
                    !storedData?.length
                        ? <figure className="flex flex-col justify-center items-center">
                            <img src="https://res.cloudinary.com/dz1fy2tof/image/upload/v1732547976/empty-cart_o9lngo.png" alt="" className="size-56" />
                            <h4 className="font-bold uppercase -mt-1 dark:text-white">You have not add anything</h4>
                        </figure>
                        :
